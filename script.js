...
let navEl = $('header nav');
let burgerEl = $('header .burger');

burgerEl.click(function(){
    navEl.toggleClass('open');
    burgerEl.toggleClass('open'); 
});

$('.cards-item').click(function(e){
    e.preventDefault();
    $(this).find('.cards-item-text').slideToggle();
});
